...
const ShopBedRoomProducts = () => {
  const [pageData, setPageData] = React.useState(Array); 
  React.useEffect(() => {        
   const filteredData = products.filter((item: { category: string; }) => (item.category === 'Cot' || item.category === 'Bed'));
...
<div className="new-in-container">
    <div className="new-in">Shop - All Bed Room Products</div>
...
export default ShopBedRoomProducts;