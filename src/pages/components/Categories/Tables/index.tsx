...
const Tables = (props: any) => {
    ...
    React.useEffect(() => {        
        const filteredData = products.filter((item: { category: string; }) => item.category === 'Table');
        setPageData(filteredData);
    },[]);
      
    return (
    <div className="new-in-container">
    <div className="new-in">Tables</div>
        <div className="product-box-card-container">
        <div className="product-box">
          {pageData.length===0 && <div className="product-details-empty">No Products Available in Tables</div>}          
